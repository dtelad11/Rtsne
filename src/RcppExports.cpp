...
// Rtsne_cpp
Rcpp::List Rtsne_cpp(NumericMatrix X, int no_dims_in, double perplexity_in, double theta_in, bool verbose, int max_iter, bool distance_precomputed, NumericMatrix Y_in, bool init, int stop_lying_iter_in, int mom_switch_iter_in, double momentum_in, double final_momentum_in, double eta_in, double exaggeration_factor_in, int n_landmarks);
RcppExport SEXP Rtsne_Rtsne_cpp(SEXP XSEXP, SEXP no_dims_inSEXP, SEXP perplexity_inSEXP, SEXP theta_inSEXP, SEXP verboseSEXP, SEXP max_iterSEXP, SEXP distance_precomputedSEXP, SEXP Y_inSEXP, SEXP initSEXP, SEXP stop_lying_iter_inSEXP, SEXP mom_switch_iter_inSEXP, SEXP momentum_inSEXP, SEXP final_momentum_inSEXP, SEXP eta_inSEXP, SEXP exaggeration_factor_inSEXP, SEXP n_landmarksSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(Rtsne_cpp(X, no_dims_in, perplexity_in, theta_in, verbose, max_iter, distance_precomputed, Y_in, init, stop_lying_iter_in, mom_switch_iter_in, momentum_in, final_momentum_in, eta_in, exaggeration_factor_in, n_landmarks));
